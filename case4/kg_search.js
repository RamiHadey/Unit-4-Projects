...
//step 4 different global variables 
var allCells;
var found = false;

//step 3 when page is loaded it inserts into the word search table
window.onload = init;

function init() {
   //step 5
   document.querySelectorAll("aside h1")[0].innerHTML = wordSearchTitle;
   //The ID wordTable becomes draw word search
   ...
   for (var i = 0; i < allCells.length; i++) {
      ...
      //the event listener is mouseDown
      //the handler is startRecording
   ...
   document.getElementById("wordSearchTable").onmouseup = function() {
      ...
      if (solved) {
         //When the puzzle is solved an alert pops up
